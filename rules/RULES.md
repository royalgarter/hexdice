...
- [v1.1 Merging](/rules?path=rules/v1.1.md)
- [v1.2 Terrain](/rules?path=rules/v1.2.md)
- [v1.3 Fog of war](/rules?path=rules/v1.3.md)
- [v1.4 Terraform](/rules?path=rules/v1.4.md)
- [v1.5 Epic Chess Mode](/rules?path=rules/v1.5.md)
- [v1.6 Empires Mode](/rules?path=rules/v1.6.md)
- [v1.7 Resources Hex](/rules?path=rules/v1.7.md)
- [v1.8 Terrain Height](/rules?path=rules/v1.8.md)
- [v2.0 Destiny Dice Combat Mode ](/rules?path=rules/v2.0.md)
- [v3.0 Campaign - Journey of the Six](/rules?path=rules/v3.0.md)
